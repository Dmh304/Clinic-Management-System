...
public interface NotificationService {
    ...
    /** Tạo 1 thông báo cho toàn bộ Lễ tân (targetRole = "RECEPTIONIST"). Mặc định entityType
     *  "APPOINTMENT" (giữ tương thích các call site cũ — relatedId thực sự là appointmentId). */
    void createForReceptionists(String message, Long relatedAppointmentId);

    /** Như trên nhưng entityId có thể thuộc bất kỳ loại thực thể nào (vd "CARE_SESSION",
    ...
    /** Tạo 1 thông báo cho toàn bộ Quản lý phòng khám (targetRole = "MANAGER"). UC-48. */
