...
(5, 17, N'EMP005', N'Ngô Bạch Thắng',     N'Lễ tân',      N'Lễ tân viên',  N'0967000017', '2025-01-06', 'ACTIVE', GETDATE());
...
-- ============================================================================
DECLARE @pw_demo NVARCHAR(255) = N'$2a$10$gfSU.mS4YQd7cICUyobl/en..jS9epCm4YpeYiRbllaEL2TbAOGmy'; -- Password@123

-- 24.1 users — tài khoản đăng nhập (vai trò PATIENT = role_id 8)
SET IDENTITY_INSERT users ON;
INSERT INTO users
    (id, email, password, full_name, phone_number, date_of_birth, gender,
     address, department, role_id, status, auth_provider, created_at)
