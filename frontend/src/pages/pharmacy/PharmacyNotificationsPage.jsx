...
export default function PharmacyNotificationsPage() {
  ...
  return (
    <div style={{ padding: 24, background: '#f0f4ff', minHeight: 'calc(100vh - 64px)' }}>
      <Typography.Title level={4} style={{ marginBottom: 4 }}>
        <BellOutlined style={{ marginRight: 8 }} />Thông báo Dược sĩ
      </Typography.Title>
          ...
          renderItem={(n) => (
            ...
            >
              ...
              {n.relatedAppointmentId && (
                <span style={{ fontSize: 12, color: '#2563eb' }}>Xem danh sách phát thuốc →</span>
              )}
            </List.Item>
          )}
        />
