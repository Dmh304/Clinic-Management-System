...
CREATE TABLE services (
    ...
    CONSTRAINT CK_services_service_type CHECK (service_type IN ('EXAM', 'DIAGNOSTIC', 'CARE'))
);
GO
...
-- ----------------------------------------------------------------------------
-- 28. rooms — danh sách phòng khám / phòng làm việc
-- ----------------------------------------------------------------------------
CREATE TABLE rooms (
...
-- ----------------------------------------------------------------------------
-- 29. staff_room_assignments — phân công nhân sự vào phòng
